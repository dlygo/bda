...
'''generates `n` number of floating-point numbers (e.g. 10,000), 
each randomly ranging from 0 to 100. 
...
def serial_runner():
    ...
    print(f'Serial run: {round(end-start,2)} second(s)')
...
def parallel_runner2():
    ...
    print(f"Parallel run: {round(end-start,2)} second(s)")
